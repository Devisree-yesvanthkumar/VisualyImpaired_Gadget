...
video_path = r"G:\project code january\object_detection_distance\img5.jpg"
...
def annotate_frame(frame, detections):
    for detection in detections:
        ...
        if distance_cm < 50:
            print("Unsafe")
            speech_text = f"Detected {class_name} at {distance_cm:.2f} centimeters. Unsafe."
        else:
            print("Safe")
            speech_text = f"Detected {class_name} at {distance_cm:.2f} centimeters. Safe."
